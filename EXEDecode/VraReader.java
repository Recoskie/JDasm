...
if(disk[0]>0){Data.seek(disk[0]);if(disk[1]<(length)){Data.read(b,r,(int)disk[1]);}else{Data.read(b,r,length);}}
r+=disk[1];pos+=disk[1];}}else{Data.seek(pos);Data.read(b,0,b.length);}}catch(Exception e){System.out.println("READING ERROR");};
return(b);}
...
//**************************************close the VRA READER********************************************

public void close(){try{Data.close();}catch(Exception e){System.out.println("Err well closing Vra Reader");}}
