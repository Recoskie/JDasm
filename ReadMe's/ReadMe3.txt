...
if a company cindaly wants to add there format to my program go ahead but note the idea of this application is not to
disply the output of a file but to display what each section of bytes do in the format and how it works